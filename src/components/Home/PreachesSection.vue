<template>
    <section class="flex flex-wrap flex-row-reverse justify-center gap-10 items-center my-10">
        <article>
        ...
        <article class="flex flex-col gap-4 items-center md:items-start">
            <h2 class="text-xl text-ibc_blue-500 font-bold">Prédicas IBC</h2>
            <p class="text-sm text-ibc_gray-300">Disponibles en nuestro canal de Youtube.</p>
            <button class="bg-ibc_red-500 rounded-full text-white text-sm h-12 w-48">Escúchalas aquí</button>
         </article>
    </section>
</template>